...
| `--chart-bg` | `rgba(255,252,244,.4)` | `rgba(255,255,255,.045)` | North Indian chart interior |
| `--shadow-rgb` / `--shadow-rgb2` | `150,110,40` / `184,144,47` | `0,0,0` / `0,0,0` | accent-shadow color (use as `rgba(var(--shadow-rgb),α)`) — control shadows, tdot focus ring |
